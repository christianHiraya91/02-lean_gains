...
function handleSubmit (event) {
  ...
  const layout = `
    <div class="result-content">
      <ul>
        <li>
         Your BMR: <strong>${tmb} Calories/Day</strong>.
        </li>
        <li>
          Maintain weight: <strong>${maintenance} Calories/Day</strong>.
        </li>
        <li>
          Weight loss: <strong>${loseWeight} Calories/Day</strong>.
        </li>
        <li>
          Weight gain: <strong>${gainWeight} Calories/Day</strong>.
        </li>
      </ul>
  `;
